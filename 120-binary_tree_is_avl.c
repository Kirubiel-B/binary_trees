...
/**
 * binary_tree_is_avl - binary tree is a valid AVL tree.
 * @tree: root node of the tree to check.
 *
 * Return: 1 if is a valid AVL tree, and 0 otherwise
 */
int binary_tree_is_avl(const binary_tree_t *tree)
{
	if (tree == NULL)
