...
/**
 * create_node - new levelorder_queue_t node.
...
/**
 * push - back of a levelorder_queue_t queue.
 * @node: tree node to print and push.
 ...
 *
 * Return: tree is NULL or not complete, 0.
 *         Otherwise, 1.
 *
 * Description: exits with a status code of 1.
 */
